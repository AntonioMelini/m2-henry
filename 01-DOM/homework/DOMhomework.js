...
function buildToDos(toDos) {
  // Tu código acá:
  var objttodos= toDos.map(buildToDo)
  return objttodos;
}
...
function addToDo() {
  // Tu código acá:
  var nuevotodo = new ToDo(document.getElementById("toDoInput").value);
...
boton.addEventListener("cliclk",addToDo);
// o boton.onclick=addToDo;
